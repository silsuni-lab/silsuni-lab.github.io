...
export const zhCN: Catalog = {
  ...
  // 方形袋 — 意思相同的文字共用 round.*。
  'square.field.widthMm': '宽',
  'square.field.depthMm': '侧幅',
  'square.field.sideHeightMm': '侧面高度',
  'square.field.lidHeightMm': '盖子高度',
  'square.preset.mini': '迷你收纳袋',
  'square.preset.cosmetic': '化妆包',
  'square.preset.travel': '旅行收纳袋',
  'square.pattern.name': '方形提手收纳袋',
  'square.piece.panels': '盖子・底部',
