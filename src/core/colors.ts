 ...
 *
 * 검정이다. 처음엔 팔레트에 비어 있던 녹색(#2f6f3e)을 썼는데, 가는 선이라
 * 인쇄하면 흐려서 식서가 안 찍힌 줄 알았다. 흑백 프린터에서는 더 옅다.
 * 재단선과 색이 같아지지만 양끝 화살촉과 가는 굵기(page.ts GRAIN_THICKNESS)가
 * 식서선을 가른다.
 */
export const GRAIN_COLOR = '#000000';
